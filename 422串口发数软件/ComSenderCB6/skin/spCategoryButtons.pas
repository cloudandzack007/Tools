  ...
  begin
    ...
    then
      DrawImageAndText(Buffer.Canvas, NewClRect, -1, 2, blGlyphLeft,
         Button.Caption, Button.ImageIndex, FImages, spbdsSelected in State, True,
         False, 0)
    else
      DrawImageAndText(Buffer.Canvas, NewClRect, -1, 0, blGlyphLeft,
         '', Button.ImageIndex, FImages, spbdsSelected in State, True, False, 0);
  end;
  //
...
begin
  ...
  begin
    ...
    then
      DrawImageAndText(Buffer.Canvas, NewClRect, -1, 2, blGlyphLeft,
         Button.Caption, Button.ImageIndex, FImages, spbdsSelected in State, True, False, 0)
    else
      DrawImageAndText(Buffer.Canvas, NewClRect, -1, 0, blGlyphLeft,
         '', Button.ImageIndex, FImages, spbdsSelected in State, True, False, 0);
  end;
...
begin
  ...
  begin
    inherited Assign(Source);
{    InterfaceData := TspButtonItem(Source).InterfaceData;}
  end
  else
    inherited Assign(Source);
end;
