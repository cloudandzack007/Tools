...
use ifnls
    ...
    interface
        ...
        integer(4) function xlSheetprint_Gridlines(handle)
        !DEC$ATTRIBUTES C, DLLIMPORT, ALIAS:'_xlSheetprint_GridlinesA' :: xlSheetprint_Gridlines
        import
        type(SheetHandle) handle
        end function

        subroutine xlSheetSetprint_Gridlines(handle,print_)
        !DEC$ATTRIBUTES C, DLLIMPORT, ALIAS:'_xlSheetSetprint_GridlinesA' :: xlSheetSetprint_Gridlines
        import
        type(SheetHandle) handle
        integer(4) print_
        end subroutine
        ...
        integer(4) function xlSheetprint_Zoom(handle)
        !DEC$ATTRIBUTES C, DLLIMPORT, ALIAS:'_xlSheetprint_ZoomA' :: xlSheetprint_Zoom
        import
        type(SheetHandle) handle
        end function

        subroutine xlSheetSetprint_Zoom(handle,zoom)
        !DEC$ATTRIBUTES C, DLLIMPORT, ALIAS:'_xlSheetSetprint_ZoomA' :: xlSheetSetprint_Zoom 
        import
        type(SheetHandle) handle
        integer(4) zoom
        end subroutine
        ...
        integer(4) function xlSheetprint_RowCol(handle)
        !DEC$ATTRIBUTES C, DLLIMPORT, ALIAS:'_xlSheetprint_RowColA' :: xlSheetprint_RowCol
        import
        type(SheetHandle) handle
        end function

        subroutine xlSheetSetprint_RowCol(handle,print_)
        !DEC$ATTRIBUTES C, DLLIMPORT, ALIAS:'_xlSheetSetprint_RowColA' :: xlSheetSetprint_RowCol
        import
        type(SheetHandle) handle
        integer(4) print_
        end subroutine
