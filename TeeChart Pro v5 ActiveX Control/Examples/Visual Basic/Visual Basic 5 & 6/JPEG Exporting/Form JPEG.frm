...
Begin VB.Form Form1 
   ...
   Begin TeeChart.TChart TChart1 
      Height          =   2955
      Left            =   60
      OleObjectBlob   =   "Form JPEG.frx":0000
      TabIndex        =   0
      Top             =   60
      Width           =   4035
   End
...
Dim Optimize As EJPEGPerformance
  ...
  With TChart1.Export.asJPEG
    ...
    .SaveToFile "c:\temp\mychart.jpg"
  
    MsgBox "Chart saved to c:\temp\mychart.jpg file ! "
    Label4.Caption = Str$(FileLen("c:\temp\mychart.jpg")) + " bytes"
    Command2.Enabled = True
  End With
End Sub

Private Sub Command2_Click()
  Picture1.Picture = LoadPicture("c:\temp\mychart.jpg")
