...
typedef void __fastcall (__closure *TComExceptionEvent)(System::TObject* Sender, TComExceptions TComException, AnsiString ComportMessage, __int64 WinError, AnsiString WinMessage);
...
private:
	...
	void __fastcall CallException(Word AnException, const __int64 WinError = 0x000000000);
...
public:
	...
	int __fastcall WriteUnicodeString(const WideString Str);
	int __fastcall ReadUnicodeString(WideString &Str, int Count);
...
static const Shortint CError_PortNotOpen = 0x18;
