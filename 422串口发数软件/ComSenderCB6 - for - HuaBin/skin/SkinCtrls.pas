...
type
  ...
  public
   ...
   TspButtonPaintEvent = procedure(Cnvs: TCanvas; R: TRect; ADown, AMouseIn: Boolean;
...
begin
  ...
  then
    FOnPaint(B.Canvas, NewClRect, ADown, AMouseIn, FDrawDefault);
...
begin
  ...
  if Assigned(FOnPaint)
  then
    FOnPaint(B.Canvas, ClientRect, FDown, FMouseIn, FDrawDefault);
      ...
      for i := 0 to ControlCount - 1 do
        ...
        then
          begin
            ...
            Inc(R.Right, 2);
            Inc(R.Bottom, 2);
            PaintControlFrame(Canvas, Controls[i], R);
          end;
...
begin
  ...
  then
    begin
      DrawImageAndText(B.Canvas, TR, FMargin, FSpacing, FLayout,
        _Caption, FImageIndex, FButtonImages, ADown and AMouseIn, Enabled,
...
begin
  ...
  then
    begin
      DrawImageAndText(B.Canvas, ClientRect, FMargin, FSpacing, FLayout,
        _Caption, FImageIndex, FButtonImages, FDown and FMouseIn, Enabled,
        FDrawColorMarker, FColorMarkerValue);
    end
  else
  DrawGlyphAndText(B.Canvas,
